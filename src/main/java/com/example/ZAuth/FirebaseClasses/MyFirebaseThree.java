...
@Component
public class MyFirebaseThree {

    @Autowired
    FirebaseConfig firebaseConfig;

    public String findUserByFacebookIdAndUpdateToken(String facebookId,String authToken,String clientId,String platform){
        try {
            ...
            Query query = collectionRef.whereEqualTo("FacebookId",facebookId);
    ...
    public String createUserWithFacebookCredintials(AddUserWithFacebookData data, String encryptedToken) {
        String userId = String.valueOf(UUID.randomUUID());
        String clientId = data.getClientId();
        Map<String, Object> userInfo = new HashMap<>();

        userInfo.put("FacebookId", data.getFacebookId());
        userInfo.put("AuthMethod", "Facebook");
